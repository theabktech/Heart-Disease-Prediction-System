...
saved_model = h2o.load_model("/content/drive/MyDrive/Heart Dataset/Final Models/my_ensemble_binomial")
...
def preprocess(age,sex,cp,trestbps,restecg,chol,fbs,thalach,exang,oldpeak,slope,ca,thal ):   
    ...
    df = pd.DataFrame({"age":age,"sex":sex,"cp":cp,"trestbps":trestbps,"restecg":restecg,"chol":chol,"fbs":fbs,"thalach":thalach,"exang":exang,"oldpeak":oldpeak,"slope":slope,"ca":ca,"thal":thal}, index = [0])
    hf = h2o.H2OFrame(df)
...
st.subheader('by Abhinav Kulshreshth ')
